          ...
          <div class="tab-content" id="myTabContent">
            <div class="tab-pane fade border p-3 show active" id="home-tab-pane" role="tabpanel" aria-labelledby="home-tab">
              ...
              <div class="mb-3">
                ...
                <textarea name="small_deskripsi" class="form-control">{{ $product->small_deskripsi }}</textarea>
              </div>
              <div class="mb-3">
            ...
            <div class="tab-pane fade border p-3" id="image-tab-pane" role="tabpanel" aria-labelledby="image-tab">
              ...
              <div>
                ...
                <div class="row">
                  ...
                  <div class="col-md-2">
                    <img src="{{ asset($image->image) }}" style="width: 100px; height: 100px" class="me-4 border p-1" alt="Image">
