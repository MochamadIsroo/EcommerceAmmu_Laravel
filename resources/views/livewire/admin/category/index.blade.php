            ...
            <div class="modal-content">
                ...
                <form wire:submit.prevent="destroyCategory">
                    <div class="modal-body">
                        <h6>Apakah kamu yakin ingin menghapus data ?</h6>
                    </div>
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>
                                    ...
                                    <a href="" wire:click="deleteCategory({{$category->id}})" class="btn btn-sm btn-danger" data-bs-toggle="modal" data-bs-target="#deleteModal">Delete</a>
                                </td>
                            </tr>
                            @endforeach
                        </tbody>
